...
var PrivateConstructorError = /** @class */ (function (_super) {
  ...
  function PrivateConstructorError (className) {
    var _this = this
    var msg =
      'Cannot construct ' + className + ' - it has a private constructor'
    _this = _super.call(this, msg) || this
    return _this
  }
...
var UnexpectedObjectTypeError = /** @class */ (function (_super) {
  ...
  function UnexpectedObjectTypeError (expected, actual) {
    ...
    var name = function (t) {
      var _a, _b
      return (_a = t === null || t === void 0 ? void 0 : t.name) !== null &&
        _a !== void 0
        ? _a
        : (_b = t === null || t === void 0 ? void 0 : t.constructor) === null ||
          _b === void 0
        ? void 0
        : _b.name
    }
...
var ReparseError = /** @class */ (function (_super) {
  ...
  function ReparseError (className, methodName) {
    var _this = this
    var msg =
      'Cannot call ' + className + '.' + methodName + '() more than once'
    _this = _super.call(this, msg) || this
    return _this
  }
  return ReparseError
  ...
  function UnrecognizedStreamTypeError (stream) {
    ...
    var streamType =
      (_c =
        (_b =
          (_a =
            stream === null || stream === void 0
              ? void 0
              : stream.contructor) === null || _a === void 0
            ? void 0
            : _a.name) !== null && _b !== void 0
          ? _b
          : stream === null || stream === void 0
          ? void 0
          : stream.name) !== null && _c !== void 0
        ? _c
        : stream
...
var MissingKeywordError = /** @class */ (function (_super) {
  ...
  function MissingKeywordError (pos, keyword) {
    var _this = this
    var msg =
      "Did not find expected keyword '" + utils_1.arrayAsString(keyword) + "'"
    _this = _super.call(this, pos, msg) || this
    return _this
  }
